...
export default function CompanyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Sobre a Leidy Cleaner</h1>
      
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-semibold mb-3 text-blue-700">Quem Somos</h2>
        <p className="text-gray-700 mb-4">{info.description || info.about || 'Somos a Leidy Cleaner, especializada em serviços de limpeza profissional para residências, escritórios e eventos.'}</p>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        ...
        <p className="text-gray-700 mb-2"><strong>Email:</strong> {info.email || 'contato@leidycleaner.com.br'}</p>
