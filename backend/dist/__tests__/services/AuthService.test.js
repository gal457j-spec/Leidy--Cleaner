...
describe('AuthService', () => {
    ...
    const mockHashPassword = password.hashPassword;
    const mockComparePassword = password.comparePassword;
    const mockGenerateTokens = jwt.generateTokens;
    const mockVerifyRefreshToken = jwt.verifyRefreshToken;
    beforeEach(() => {
        jest.clearAllMocks();
    });
    describe('register', () => {
    ...
    describe('login', () => {
        it('should return user and tokens on successful login', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('SELECT'), [credentials.email]);
