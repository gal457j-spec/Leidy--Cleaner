...
describe('ServiceService', () => {
    ...
    describe('getAll', () => {
        ...
        it('should filter services by category', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('WHERE'), expect.anything());
            expect(result).toEqual(services);
        });
        it('should search services by name', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('ILIKE'), expect.anything());
            expect(result).toEqual(services);
        });
    });
    describe('getById', () => {
    ...
    describe('create', () => {
        it('should create a new service', async () => {
            ...
            const result = await ServiceService.create(serviceData.name, serviceData.category, serviceData.base_price, serviceData.duration_minutes, serviceData.description);
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('INSERT'), expect.anything());
    ...
    describe('getCategories', () => {
        it('should return all service categories', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('DISTINCT'));
            expect(result).toEqual(categories.map(c => c.category));
        });
    });
});
//# sourceMappingURL=ServiceService.test.js.map